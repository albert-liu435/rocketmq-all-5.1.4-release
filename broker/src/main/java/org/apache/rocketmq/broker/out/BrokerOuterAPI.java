...
public class BrokerOuterAPI {
    ...
    /**
     * 可以看出，注册 Broker 时，是向所有 NameServer 异步注册，通过 CountDownLatch 等待所有注册返回。从这我们可以了解到，NameServer 集群是无状态的，每个 NameServer 都有一份完成的 Broker 数据，
     * 因为 Broker 会将自己注册给每个 NameServer。
     * <p>
     * <p>
